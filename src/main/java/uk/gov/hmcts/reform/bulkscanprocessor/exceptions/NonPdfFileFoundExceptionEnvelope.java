...
public class NonPdfFileFoundExceptionEnvelope extends EnvelopeRejectionException {

    private static final long serialVersionUID = 9143161748679833084L;

    public NonPdfFileFoundExceptionEnvelope(String zipFileName, String fileName) {
