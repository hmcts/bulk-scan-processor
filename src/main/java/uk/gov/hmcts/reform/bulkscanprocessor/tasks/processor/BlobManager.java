...
public class BlobManager {
    ...
    public Optional<String> acquireLease(CloudBlockBlob cloudBlockBlob, String containerName, String zipFilename) {
        try {
            ...
            return Optional.of(cloudBlockBlob.acquireLease(properties.getBlobLeaseTimeout(), null));
    ...
    public void tryMoveFileToRejectedContainer(CloudBlockBlob blob, String inputContainerName, String leaseId) {
    ...
    private void moveFileToRejectedContainer(CloudBlockBlob blob, String rejectedContainerName, String leaseId)
        ...
        AccessCondition condition = leaseId != null
            ? AccessCondition.generateLeaseCondition(leaseId)
            : AccessCondition.generateEmptyCondition();

        blob.deleteIfExists(DeleteSnapshotsOption.NONE, condition, null, null);
