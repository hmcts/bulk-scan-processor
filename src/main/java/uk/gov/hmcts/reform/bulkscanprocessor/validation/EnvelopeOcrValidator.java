...
public class EnvelopeOcrValidator {
    ...
    private final EnvelopeOcrPresenceValidator presenceValidator;
    ...
    public EnvelopeOcrValidator(
        ...
        EnvelopeOcrPresenceValidator presenceValidator,
    ...
    private Optional<ScannableItem> findDocWithOcr(Envelope envelope) {
        return presenceValidator.assertHasProperlySetOcr(envelope.getScannableItems());
    }
