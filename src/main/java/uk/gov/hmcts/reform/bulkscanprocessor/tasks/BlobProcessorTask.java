...
public class BlobProcessorTask extends Processor {
    ...
    private void processZipFileIfEligible(CloudBlobContainer container, String zipFilename)
        ...
        if (existingEnvelope != null) {
            ...
            deleteIfReadyForDeletion(cloudBlockBlob, existingEnvelope, container.getName());
    ...
    private void deleteIfReadyForDeletion(CloudBlockBlob cloudBlockBlob, Envelope envelope, String containerName) {
