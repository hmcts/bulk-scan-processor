...
public class QuickStart {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        File sampleFile = new File("/Users/nitinprabhu/hmcts/platform/1_24-06-2018-00-00-00.zip");

        try {

            File downloadedFile = new File("/Users/nitinprabhu/hmcts/platform/1_24-06-2018-00-00-00.zip");

            // Retrieve the credentials and initialize SharedKeyCredentials
            String accountName = "bulkscansandbox";
            String accountKey = "jBPwUHVYnFEA+a06pFVC5OdljkPGEYKQO/JnWgiulOrXjPu6aNpeK7qAm0McW3K8TYLY8LWb84KXWx/2zrK/qg==";

            // Create a ServiceURL to call the Blob service. We will also use this to construct the ContainerURL
            SharedKeyCredentials creds = new SharedKeyCredentials(accountName, accountKey);
            // We are using a default pipeline here, you can learn more about it at https://github.com/Azure/azure-storage-java/wiki/Azure-Storage-Java-V10-Overview
            final ServiceURL serviceURL = new ServiceURL(new URL("https://bulkscan.sandbox.platform.hmcts.net"),
                                                         StorageURL.createPipeline(creds, new PipelineOptions().withLoggingOptions(
                                                             LoggingOptions.DEFAULT)));

            // Let's create a container using a blocking call to Azure Storage
            // If container exists, we'll catch and continue
            containerURL = serviceURL.createContainerURL("bulkscan");
