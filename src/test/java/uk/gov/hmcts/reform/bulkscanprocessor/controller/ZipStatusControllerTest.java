...
public class ZipStatusControllerTest {
    ...
    private static final String ccdid = "34643746765475";
    ...
    public void should_return_data_returned_from_the_service_with_dcn_as_parameter() throws Exception {
        ...
        List<ZipFileStatus> zipFileStatusList = Arrays.asList(new ZipFileStatus(fileName, null, envelopes, events));
    ...
    public void should_return_data_returned_from_the_service() throws Exception {
        ...
        given(service.getStatusFor(fileName)).willReturn(new ZipFileStatus(fileName, null, envelopes, events));
    ...
    public void should_return_200_with_empty_model_if_no_results_were_found() throws Exception {
        ...
        given(service.getStatusFor(fileName)).willReturn(
            new ZipFileStatus(fileName, null, emptyList(), emptyList())
        );
    ...
    public void should_return_200_with_empty_model_if_no_results_were_found_with_given_ccdId() throws Exception {
        String unmatchedCcdId = "34643746765475";
        given(service.getStatusByCcdId(unmatchedCcdId))
            .willReturn(new ZipFileStatus(null, unmatchedCcdId, emptyList(), emptyList()));
        mockMvc
            .perform(get("/zip-files").param("ccd_id", unmatchedCcdId))
            .andDo(print())
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.ccd_id").value(unmatchedCcdId))
            .andExpect(jsonPath("$.envelopes").isEmpty())
            .andExpect(jsonPath("$.events").isEmpty());
    }
    ...
    public void should_return_bad_request_when_no_parameter_supplied() throws Exception {
        given(service.getStatusFor(fileName)).willReturn(
            new ZipFileStatus(null, null, emptyList(), emptyList())
        );
        mockMvc
