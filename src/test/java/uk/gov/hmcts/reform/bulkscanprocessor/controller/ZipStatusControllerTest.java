...
public class ZipStatusControllerTest {
    ...
    public void should_throw_exception_when_both_parameters_together() throws Exception {
        ...
        mockMvc
            .perform(get("/zip-files").queryParams(map))
            .andDo(print())
    ...
    public void should_return_400_if_more_than_one_parameter_provided() throws Exception {
        ...
        zipFileStatusList.add(new ZipFileStatus(fileName, emptyList(), emptyList()));
        given(service.getStatusByDcn(dcn)).willReturn(zipFileStatusList);
